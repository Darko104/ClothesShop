window.onload = function () {
    ...
    $(".in-cart").bind({
        ...
        'click': function () {window.location = "cart.php";}
    });
...
const slider = (() => {
    ...
    const writeNewValuesInSlider = () => {
        ...
        $(sliderFields.buyButton).attr("href", "shop.php?productId="+element.data("productid"))
    }
            ...
            success: function (product) {
                ...
                html += `</div>
                    ...
                    <div id="specific-product-info-footer">
                        <div class="product-attributes">
                            <p id="product-tags" class="product-attribute"><span class="pa-key">Category:</span> <span>${product.categoryName}</span></p>
    ...
    const writeProductsInTable = (products) => {
        ...
        for (var pr of products) {
            html += `<tr>
                ...
                <td>${pr.units_sold}</td>
                <td><button class="panel-btn panel-view-btn"><a href="shop.php?productId=${pr.productId}">View</a></button></td>
