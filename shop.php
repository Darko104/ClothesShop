            ...
            <div id="full-grid-products" class="track">
                ...
                <article class="product-card">
                    <div class="product-card-info">
                        <a href="product.php?productId=<?=$products[$i]->productId?>"><img src="assets/images/<?=$products[$i]->imageName?>"></a>
                        <p class="product-card-name">
                            <a href="product.php?productId=<?=$products[$i]->productId?>"><?=cropString($products[$i]->productName, 33);?></a>
                        </p>
