    ...
    <section id="sign-in">
        ...
        <section id="sign-in-types">
            <div id="sign-in-wrapper">
                ...
                <p class="sign-in-type-desc">If you have an account, sign in with your email address. If not <a href="sign_up.php">create it now</a>.</p>
            ...
            <div id="go-to-signup-wrapper">
                ...
                <button id="go-to-sign-up" class="signing-button" onclick="location.href = 'sign_up.php';">Create an account</button>
            </div>
        </section>
    </section>
