    ...
    <div id="header-featured">
        <section id="header-featured-slider">
            ...
            <div id="header-featured-product-info">
                ...
                <a href="index.php?page=product&productId=<?=$featuredProducts[0]->productId?>" id="slider-buy">
...
<main id="home-main">
    <section id="news-cards">
        <div class="promo-card" id="news-card-1">
            <a href="index.php?page=shop&brand%5B%5D=2">
        ...
        <div class="promo-card" id="news-card-3">
            <a href="index.php?page=shop&category%5B%5D=1">
                <div class="promo-card-text">
            ...
            <article class="product-card">
                ...
                <div class="product-card-info">
                    <p class="product-card-name">
                        <a href="index.php?page=product&productId=<?=$product->productId?>"><?=cropString($product->productName, 33);?></a>    
                    </p>
    ...
    <section id="categories-grid-wrapper">
        <section id="categories-grids">
            <article id="grid-small-1">
                <a href="index.php?page=shop&category%5B%5D=1"><button class="grid-section-button">Sneakers</button></a>
            </article>
            <article id="grid-small-2">
                <a href="index.php?page=shop&category%5B%5D=1&category%5B%5D=4&collection%5B%5D=1&collection%5B%5D=2"><button class="grid-section-button">Running</button></a>
            </article>
            <article id="grid-big">
                <a href="index.php?page=shop&category%5B%5D=1&category%5B%5D=3&category%5B%5D=4&collection%5B%5D=1&collection%5B%5D=2"><button class="grid-section-button">Training</button></a>
            </article>
            <article id="grid-small-3">
                <a href="index.php?page=shop&min-price=&max-price=150&sort=productPrice&sorttype=asc">
                <button class="grid-section-button">Affordable</button></a>
            </article>
            <article id="grid-small-4">
                <a href="index.php?page=shop&category%5B%5D=5"><button class="grid-section-button">Accessories</button></a>
            </article>
        </section>
        <a href="index.php?page=shop"><button id="categories-grid-main-button" class="grid-section-button">View all products</button></a>
    </section>
    ...
    <section id="customer-opinions-wrapper">
        ...
        <section id="customer-opinions">
            ...
            <div id="message-on-customers">
                ...
                <button><a href="index.php?page=shop">Shop now</a></button>
            </div>
        </section>
    </section>
